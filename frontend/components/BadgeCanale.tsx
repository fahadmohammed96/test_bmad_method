 ...
 * rumore.
 *
 * Il tratteggio (`▲` Airbnb, `■` Booking, `●` altro) non è decorazione: è la
 * seconda dimensione oltre al colore, ed è ciò che rende la griglia leggibile
 * quando le prenotazioni di due portali si toccano.
 */
